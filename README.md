...
- TOPIX-17 業種別の相対株価チャート。17分類を 1 枚にまとめ、TOPIX を重ねます。
...
- `output/charts/topix17_relative_weekly.png`
...
業種別・TOPIX-17 業種別・市場別のチャートは、個別銘柄の週末営業日の調整終値を使い、銘柄ごとに最初の価格を 100 としたうえで分類ごとの中央値を取っています。さらにグラフ上の各系列も最初の値を 100 にそろえています。平均で集計したい場合は `--group-agg mean` を指定できます。
